...
class Post extends Component {
    ...
    render() { 
        ...
        <div className="post__container">
          ...
          {/* Image */}
          <div>
              <img src={this.props.postImage} width="615px" alt="this is img "/> 
          </div>

          {/* Analytics */}
          <div>
              <div style={{"marginLeft":"10px"}}>
                  <img src={love} className="post_reactimage" alt="this is img "/>
                  <img src={comment} className="post_reactimage" alt="this is img "/>
                  <img src={share} className="post_reactimage" alt="this is img "/>
              </div>
